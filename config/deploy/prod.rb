...
set :deploy_to, "/var/www/sites/virtual/bentericksen-prod"
...
role :web, "lamp01-bentericksen.ec2.metaltoad.net"

set :gateway, "mgt02-mtm.ec2.metaltoad.net"

# Specify one of the web servers to use for database backups or updates.
role :db, "lamp01-bentericksen.ec2.metaltoad.net", :primary => true
