...
import { seedConfig } from '../../resources/assets/js/store/mock-data/101-bonusPro-seed';
...
describe('Bonus Pro Plan Validation with Hygiene Plan', () => {
  it('Can generate plan setup and validate first month entry', () => {
    ...
    const keys = {
      ...
      staffSalariesTotal: { id: 'salary-bonus-total', type: 'dollar', row: 3 },
