...
import { seedConfig } from '../../resources/assets/js/store/mock-data/at-bonusPro-4m-20p-equal_share-seed';

describe('Bonus Pro Plan Validation for at-bonusPro-4m-20p-equal_share', () => {
  it('Can generate plan setup, enter 2 months, validate snapshot data', () => {
    ...
    const templateParams = {
      init: {
        ...
        production_collection_salaries: "$66,271",
        current_staff_salaries: "$13,738"
    ...
    AdminBusiness.viewAs({
      seedConfig,
      properties: { businessName: 'E2E 1660967066602:: 4m-20p-equal' }
    });
...
//
    ...
    $('a=Snapshot').click()
    browser.pause(2000)
    const staff = $('#staff').$('table').$('tbody').$$('tr');
    console.log('WHAAAAT====================================')
    console.log('WHAAAAT====================================')
    console.log($('#staff').$('table').$('tbody').$$('tr')[1].getHTML())
    console.log('WHAAAAT====================================')
    console.log('WHAAAAT====================================')
    validateSnapshot(staff, keys, { shift: 1 });
  })
})
