...
import { seedConfig } from '../../resources/assets/js/store/mock-data/1011-bonusPro-tdd-seed';
  ...
  it('Can generate plan setup with hygiene plan data with valid staff salaries', () => {
    ...
    const templateParams = {
      init: {
        ...
        production_collection_salaries: "$97,333",
        current_staff_salaries: "$6,975",
