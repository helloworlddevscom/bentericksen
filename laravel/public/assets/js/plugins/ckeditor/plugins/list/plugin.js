...
( function() {
	var listNodeNames = { ol: 1, ul: 1, al: 1 };
	...
	CKEDITOR.plugins.add( 'list', {
		...
		icons: 'bulletedlist,bulletedlist-rtl,numberedlist,numberedlist-rtl,arrowedlist', // %REMOVE_LINE_CORE%
		...
		init: function( editor ) {
			...
			editor.addCommand( 'arrowedlist', new listCommand( 'arrowedlist', 'al' ) );
