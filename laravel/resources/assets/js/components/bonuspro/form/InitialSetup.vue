    ...
    export default {
      ...
      computed: {
        ...mapState({
          ...
          currentStep: store => store.ui.currentStep || "initialSetup",
          businessId: store => store.initialSetup.business_id || store.global.businessId,
          createdBy: store => store.initialSetup.created_by || store.global.createdBy,
          errors: store => store.global.errors
        }),
      ...
      methods: {
        ...mapActions({
          ...
          saveInitialSetupDraft: "initialSetup/saveDraft",
