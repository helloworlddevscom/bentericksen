...
<script>
  ...
  import { employeeEligibleForBonus } from '../../../../utils'
  ...
  export default {
    ...
    methods: {
      ...mapActions({
        ...
        updateMonthField: "planData/updateActiveMonthField",
        updateEmployeeMonthlyData: "employeesAndFunds/updateEmployeeMonthlyData",
        saveMonthData: "employeesAndFunds/saveMonthData"
      }),
      ...
      updateMonth: function (e) {
        ...
        this.$store.dispatch('planData/updateProductionCollectionAverages')
      },
    ...
    computed: {
      ...mapState({
        ...
        employees: state => state.employeesAndFunds.employees,
        funds: state => state.employeesAndFunds.funds
      }),
      ...mapGetters('planData', [
        'activeMonth',
