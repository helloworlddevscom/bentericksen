            ...
            <tr>
                ...
                <th class="form-group m-2">
                    <select class="form-control" v-model="subject">
                        ...
                        <option value="HR Director Upcoming Renewal">HR Director Upcoming Renewal</option>
                        <option value="HR Director Payment Failed">HR Director Payment Failed</option>
                        <option value="HR Director Payment Succeeded">HR Director Payment Succeeded</option>
                        <option value="HR Director Payment Method Expiring">HR Director Payment Method Expiring</option>
