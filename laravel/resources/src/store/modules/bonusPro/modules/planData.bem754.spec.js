...
test('planData:updateField', (t) => {
  ...
  store.dispatch('bonusPro/planData/updateField', { prop: 'months.1.id', value: 1 })
...
test('planData:calculateCollectionRatio', (t) => {
  ...
  store.dispatch('bonusPro/planData/calculateCollectionRatio', store.getters['planData/activeMonth'])
...
test('planData:calculateProductionAverage', t => {
  ...
  store.dispatch('bonusPro/planData/calculateProductionAverage', 1)
...
test('planData:calculateHoursTotals', (t) => {
  ...
  store.dispatch('bonusPro/planData/calculateHoursTotals', store.getters['planData/activeMonth'])
...
test('planData:calculateSalaryTotals', (t) => {
  ...
  store.dispatch('bonusPro/planData/calculateSalaryTotals', store.getters['planData/activeMonth'])
...
test('planData:calculateSalaryBonusTotals', (t) => {
  ...
  store.dispatch('bonusPro/planData/calculateSalaryBonusTotals', store.getters['planData/activeMonth'])
...
test('planData:calculateStaffSalaryPercentageOfPandC', (t) => {
  ...
  store.dispatch('bonusPro/planData/calculateStaffSalaryPercentageOfPandC', store.getters['planData/activeMonth'])
...
test('planData:calculateHygienistsSalaryPercentageOfProd', (t) => {
  ...
  store.dispatch('bonusPro/planData/calculateHygienistsSalaryPercentageOfProd', store.getters['planData/activeMonth'])
...
test('planData:calculateBonusesToBePaid', (t) => {
  ...
  store.dispatch('bonusPro/planData/calculateBonusesToBePaid', store.getters['planData/activeMonth'])
...
test('planData:calculateEmployeeBonusPercentage', (t) => {
  ...
  store.dispatch('bonusPro/planData/calculateEmployeeBonusPercentage', store.getters['planData/activeMonth'])
...
test('planData:calculateFundsBonusAmount', (t) => {
  ...
  store.dispatch('bonusPro/planData/calculateFundsBonusAmount', store.getters['planData/activeMonth'])
...
test('planData:calculateEmployeeBonusAmount', (t) => {
  ...
  store.dispatch('bonusPro/planData/calculateEmployeeBonusAmount', store.getters['planData/activeMonth'])
