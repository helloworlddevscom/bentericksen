...
// Odd Quirk:  "-" will skip the validation from happening.   Good for 3,4,6 month average where they don't exist
// in all places after initialization.
// However, the function intentionally uses data as a pair now.
//
// Long story short:  If on the final snapshot screen, you always need the "hidden" parameter in the arrays.
// For example, here 6 month rolling average, so we are only checking the last 2 elements in the array.  The months entered.
// HOWEVER, you'll see 3 entries (others with "-").   Just make sure this is not "-".   Any number is fine/placeholder.  No
// Checking is down on this field (as the DOM element doesn't contain any data).
//
// "Received" = from DOM element/calculated result.
const templateParams = {
  ...
  production_collection_average: ["-", "59000.00", "67625.00", "70375.00", "69750.00", "72375.00", "70500.00"],
  staffSalaryBonusTotal: ["-", "13400", "13000", "12925", "13000", "18094", "17625"],
  staffSalaryPercentageOfPandC: ["-", ".227", ".192", ".184", ".186", ".186", ".191"],
  //
    ...
    },
    {
      ...
      [
        ...
        },
        {
          ...
          "month_id": 91,
          "user_id": 183,
          "hours_worked": employeeParams[0].hours_worked[3],
          "gross_pay": employeeParams[0].gross_pay[3],
          "amount_received": "0.00",
          "percentage": "24.74",
          "created_at": "2022-07-05T22:37:13.000000Z",
          "updated_at": "2022-07-05T22:41:23.000000Z",
        ...
        },
        {
          ...
          "month_id": 91,
          "user_id": 183,
          "hours_worked": employeeParams[1].hours_worked[3],
          "gross_pay": employeeParams[1].gross_pay[3],
          "amount_received": "0.00",
          "percentage": "24.74",
          "created_at": "2022-07-05T22:37:13.000000Z",
          "updated_at": "2022-07-05T22:41:23.000000Z",
