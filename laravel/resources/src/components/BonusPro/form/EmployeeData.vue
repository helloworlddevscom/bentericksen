...
<script>
    ...
    export default {
      ...
      methods: {
        ...mapActions({
          addExistingEmployeeToPlan: 'bonusPro/employeesAndFunds/addExistingEmployeeToPlan',
          createEmployee: 'bonusPro/employeesAndFunds/createEmployee',
          updateEmployeeField: 'bonusPro/employeesAndFunds/updateEmployeeField',
          setActiveEmployee: 'bonusPro/employeesAndFunds/setActiveEmployee',
          clearErrors: 'bonusPro/employeesAndFunds/clearErrors'
        }),
        isActive (tab) {
        ...
        setEmployeeData: function () {
          ...
          setTimeout(function () {
            ...
            console.log('oh hai', $('.bp_eligibility_date').datepicker)
            $('.bp_eligibility_date').datepicker({
              changeMonth: true,
              changeYear: true,
              showButtonPanel: true,
              yearRange: "-100:+10",
      ...
      computed: {
        ...mapState({
          employeeData: state => state.bonusPro.employeesAndFunds.activeEmployee,
          errors: state => state.bonusPro.employeesAndFunds.errors.employees,
          bonusDistributionType: state => state.bonusPro.initialSetup.distribution_type
        }),
        ...mapGetters({
          activeMonthlyData: 'bonusPro/employeesAndFunds/activeMonthlyData'
        }),
