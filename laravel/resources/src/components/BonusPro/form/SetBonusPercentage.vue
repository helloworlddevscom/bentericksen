...
import { isInLastSixMonths } from '@/store/modules/bonusPro/utils'
...
export default {
  ...
  methods: {
    ...mapActions({
      saveBonusPercentage: "bonusPro/bonusPercentage/save",
      saveBonusPercentageDraft: "bonusPro/bonusPercentage/saveDraft",
      updateProperty: "bonusPro/bonusPercentage/updateProperty",
      runCalculations: "bonusPro/planData/runCalculations",
      goToNextStep: "bonusPro/ui/nextStep",
      clearErrors: "bonusPro/bonusPercentage/clearErrors"
    }),
    update: function (el) {
      this.isDirty = true;
  ...
  computed: {
    ...mapState({
      ...
      hasHygiene: store => store.bonusPro.initialSetup.hygiene_plan,
      planData: store => store.bonusPro.planData,
      employeesAndFunds: store => store.bonusPro.employeesAndFunds,
      bonusPercentage: store => store.bonusPro.bonusPercentage
    }),
    ...mapGetters({
      activeMonths: 'bonusPro/planData/activeMonths',
      netProductionAverage: 'bonusPro/planData/netProductionAverage',
      netCollectionAverage: 'bonusPro/planData/netCollectionAverage',
      productionCollectionAverage: 'bonusPro/planData/productionCollectionAverage',
      collectionRatioAverage: 'bonusPro/planData/collectionRatioAverage',
      hygieneProductionAverage: 'bonusPro/planData/hygieneProductionAverage',
      productionAverage: 'bonusPro/planData/productionAverage'
    }),
    ...
    staffSalaryGoal: function () {
      ...
      if (desiredStaffPercent > 0) {
        ...
        return this.$store.state.bonusPro.planData.months[5].productionCollectionAverage * desiredStaffPercent;
      }
    },
    ...
    hygieneSalaryGoal: function () {
      ...
      if (desiredHygieneStaffPercent > 0) {
        // Per BEM-753/BEM-769, update goal calculation to use last month of rolling P&C average
        return this.$store.state.bonusPro.planData.months[5].productionAverage * desiredHygieneStaffPercent;
