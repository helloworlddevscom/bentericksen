...
<script>
    ...
    import FormAddFunds from './AddFunds.vue'
    import FormAddEmployees from './AddEmployees.vue'
    import FormEmployeeData from './EmployeeData.vue'
    import '@/lib/jquery'
    import '@/lib/jqueryUI'
    ...
    export default {
      ...
      methods: {
        ...mapActions({
          removeFund: 'bonusPro/employeesAndFunds/removeFund',
          removeEmployee: 'bonusPro/employeesAndFunds/removeEmployee',
      ...
      computed: {
        ...mapState({
          ...
          isSeparateFundsEnabled: store => store.bonusPro.initialSetup.separate_fund
        }),
        getFundId: function () {
          return this.fundId;
        },
