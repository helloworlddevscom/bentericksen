		...
		<div class="container" id="main">
			<div class="row main_wrap">	
				...
				<div class="col-md-12 heading">
					<h3><a href="{path='admin/help'}">Help</a> / Edit Help</h3>
				</div>
				<div class="col-md-12 content">

					{!! Form::open(['route' => ['admin.help.update', $helps->id], 'class' => 'form-horizontal', 'method' => 'put']) !!}
						<div class="form-group">
							<label for="help_title" class="col-md-3 control-label">Title:</label>
							<div class="col-md-6">
								@if ($errors->has('title')) <p class="help-block">{{ $errors->first('title') }}</p> @endif
								<input type="text" class="form-control" id="help_title" name="title" value="{{ $helps->title }}" placeholder="Title">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								{!! Form::select('section', $sections->section(), $helps->section, ['id' => 'help_section', 'class' => 'form-control help_section']) !!}
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<div class="col-md-10 col-md-offset-1">
								...
								<textarea id="help_answer" name="answer" class="form-control ckeditor">{{ $helps->answer }}</textarea>
							</div>
						</div>
...
@section('foot')
	...
	<script>
		...
		$( '#help_sub_section option[value!=""]' ).addClass( 'hidden' );
		$( '#help_section option[value="{{ $helps->section }}"]' ).prop( 'selected', true);			
		$( '#help_sub_section option[value="{{ $helps->sub_section }}"]' ).prop( 'selected', true);			
