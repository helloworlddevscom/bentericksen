		...
		<div class="container" id="main">
			<div class="row main_wrap">	
				...
				<div class="col-md-12 heading">
					<h3><a href="/user/job-description">Forms</a> / Add New</h3>
				</div>
				<div class="col-md-12 content">
					{!! Form::open(['url' => '/user/forms', 'class' => 'form-horizontal']) !!}
						<div class="form-group">
							<label for="job_description" class="col-md-3 col-md-offset-2 control-label">Form Title:</label>
							<div class="col-md-3">
								<input type="text" class="form-control" id="job_description" name="name" placeholder="Form Title">
							</div>
						</div>
