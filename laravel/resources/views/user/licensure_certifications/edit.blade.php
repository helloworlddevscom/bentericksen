	...
	<div id="main_body">
		<div class="container" id="main">
			<div class="row main_wrap">		
				...
				{!! Form::open(['route' => ['user.licensure-certifications.update', $licensure->id], 'method' => 'put']) !!}
					<div class="col-md-12 content">
						<div class="row form-group">
							<label for="licensure_certification_type" class="col-md-4 text-right padding-top">Licensure / Certification</label>
							<div class="col-md-5">
								<input type="text" class="form-control" id="" name="name" value="{{ $licensure->name }}" placeholder="Licensure / Certification Type">
							</div>
						</div>
					</div>
